...
#define SENSOR_INFO_SP0A20_MODEL_ID     0x2b
#define SENSOR_INFO_HI542_MODEL_ID     0xb1b1
#define SENSOR_INFO_AR0542_MODEL_ID     0x4800
#define SENSOR_INFO_T4K35_MODEL_ID     0x1481
#define SENSOR_INFO_IMX132_MODEL_ID     0x0132
#define SENSOR_INFO_IMX208_MODEL_ID     0x0208
#define SENSOR_INFO_IMX135_MODEL_ID     0x0135
#define SENSOR_INFO_OV9760_MODEL_ID     0x9760
#define SENSOR_INFO_OV2680_MODEL_ID     0x2680
#if defined(CONFIG_MSM_EEPROM)&& defined (CONFIG_AR0542)
#define SENSOR_INFO_AR0542_MODEL_Q_TECH     0x01
#define SENSOR_INFO_AR0542_MODEL_SUNNY      0x0A
#define SENSOR_INFO_AR0542_MODEL_MCNEX      0xA0
#endif
#if defined(CONFIG_MSM_EEPROM)&& defined (CONFIG_T4K35)
#define SENSOR_INFO_T4K35_MODEL_Q_TECH     0x06
#define SENSOR_INFO_T4K35_MODEL_SUNNY      0x01
#define SENSOR_INFO_T4K35_MODEL_MCNEX      0x31
#define SENSOR_INFO_T4K35_MODEL_LITEON     0x15
#define SENSOR_INFO_T4K35_MODEL_TRULY      0x02
#endif
#if defined(CONFIG_MSM_EEPROM)&& defined (CONFIG_IMX135)
#define SENSOR_INFO_IMX135_MODEL_Q_TECH     0x06
#define SENSOR_INFO_IMX135_MODEL_SUNNY      0x01
#define SENSOR_INFO_IMX135_MODEL_MCNEX      0x31
#define SENSOR_INFO_IMX135_MODEL_LITEON     0x15
#define SENSOR_INFO_IMX135_MODEL_TRULY      0x02
#endif

#define SENSOR_INFO_OV8835_MODEL_ID     0x8830
    ...
    switch(g_back_sensor_id)
    {
        ...
        case SENSOR_INFO_OV8825_MODEL_ID:
	     ...
	     case SENSOR_INFO_OV9740_MODEL_ID:
            sprintf(sensor_name, "OV9740-1.0Mp-FF");
            break;
	     case SENSOR_INFO_HI542_MODEL_ID:
            sprintf(sensor_name, "HI542-5Mp-AF");
            break;
       case SENSOR_INFO_AR0542_MODEL_ID:
            if(module_integrator_id==0x0A){ 
		         //sunny
			      sprintf(sensor_name, "AR0542-sunny-5M-AF");
		        }else if(module_integrator_id==0x1){ 
		        //qtech 
			      sprintf(sensor_name, "AR0542-qtech-5M-AF");
		        }else if(module_integrator_id==0xA0){ 
		        //mcnex
	 		      sprintf(sensor_name, "AR0542-mcnex-5M-AF");
		        }else{ 
			      sprintf(sensor_name, "AR0542-5M-AF");
		        } 
            break;
       case SENSOR_INFO_IMX135_MODEL_ID:
           if(module_integrator_id==0x01){ 
		        //sunny
			      sprintf(sensor_name, "IMX135-sunny-13Mp-AF");
		        }else if(module_integrator_id==0x02){ 
		        //truly 
			       sprintf(sensor_name, "IMX135-truly-13Mp-AF");
		         }else if(module_integrator_id==0x06){ 
		       //qtech 
			      sprintf(sensor_name, "IMX135-qtech-13Mp-AF");
		        }else if(module_integrator_id==0x15){ 
		        //liteon
			      sprintf(sensor_name, "IMX135-liteon-13Mp-AF");
		        }else if(module_integrator_id==0x31){ 
		       //mcnex
	 		      sprintf(sensor_name, "IMX135-mcnex-13Mp-AF");
		        }else{ 
			      sprintf(sensor_name, "IMX135-13Mp-AF");
		        } 
            break;
       case SENSOR_INFO_T4K35_MODEL_ID:
           if(module_integrator_id==0x01){ 
		        //sunny
			      sprintf(sensor_name, "T4K35-sunny-8Mp-AF");
		        }else if(module_integrator_id==0x02){ 
		        //truly 
			       sprintf(sensor_name, "T4K35-truly-8Mp-AF");
		         }else if(module_integrator_id==0x06){ 
		       //qtech 
			      sprintf(sensor_name, "T4K35-qtech-8Mp-AF");
		        }else if(module_integrator_id==0x15){ 
		        //liteon
			      sprintf(sensor_name, "T4K35-liteon-8Mp-AF");
		        }else if(module_integrator_id==0x31){ 
		       //mcnex
	 		      sprintf(sensor_name, "T4K35-mcnex-8Mp-AF");
		        }else{ 
			      sprintf(sensor_name, "T4K35-8Mp-AF");
		        } 
            break;
       case SENSOR_INFO_OV8835_MODEL_ID:
	  	if(module_integrator_id==0x01){ 
		//sunny
			sprintf(sensor_name, "OV8835-sunny-8Mp-AF");
		}else if(module_integrator_id==0x02){ 
		//truly 
			sprintf(sensor_name, "OV8835-truly-8Mp-AF");
		}else if(module_integrator_id==0x06){ 
		//qtech 
			sprintf(sensor_name, "OV8835-qtech-8Mp-AF");
		}else if(module_integrator_id==0x15){ 
		//liteon
			sprintf(sensor_name, "OV8835-liteon-8Mp-AF");
		}else if(module_integrator_id==0x31){ 
		//mcnex
	 		sprintf(sensor_name, "OV8835-mcnex-8Mp-AF");
		}else{ 
			sprintf(sensor_name, "OV8835-8Mp-AF");
		} 
            break;
        default:
                                            ...
                                            char *buf)
{
	...
	case SENSOR_INFO_SP0A28_MODEL_ID:
            ...
            break;
	case SENSOR_INFO_SP0A20_MODEL_ID:
            sprintf(sensor_name, "SP0A20-0.3Mp-FF");
            break;
	case SENSOR_INFO_OV9760_MODEL_ID:
            sprintf(sensor_name, "OV9760-1.0Mp-FF");
            break;
	case SENSOR_INFO_OV2680_MODEL_ID:
            sprintf(sensor_name, "OV2680-2.0Mp-FF");
            break;			
	case SENSOR_INFO_IMX132_MODEL_ID:
            sprintf(sensor_name, "IMX132-2Mp-FF");
            break;		
	case SENSOR_INFO_IMX208_MODEL_ID:
            sprintf(sensor_name, "IMX208-2Mp-FF");
            break;	
        default:
            sprintf(sensor_name, "No sensor or error ID!");
            break;
...
void msm_sensorinfo_set_back_sensor_module_id(uint16_t module_id)
{
    ...
    g_back_sensor_module_id = module_id;
